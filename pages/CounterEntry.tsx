...
const CounterEntry: React.FC<CounterEntryProps> = ({ 
  ...
  const anticipatedReceipt = useMemo(() => getNextAvailableReceipt(), [students, branchCollections]);
          ...
          <div className="grid md:grid-cols-12 gap-8">
            <div className="md:col-span-8">
              <form onSubmit={handleSubmit} className="bg-white rounded-[2.5rem] p-10 shadow-2xl border border-slate-100 space-y-8">
                ...
                <button 
                  type="submit" 
                  disabled={!anticipatedReceipt || (isAccountRequired && !form.sourceAccount) || !form.amount || parseFloat(form.amount) <= 0} 
